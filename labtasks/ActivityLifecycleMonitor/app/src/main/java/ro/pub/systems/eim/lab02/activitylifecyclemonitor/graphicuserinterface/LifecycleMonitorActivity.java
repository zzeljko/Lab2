...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText usernameEditText = (EditText)findViewById(R.id.username_edit_text);
        EditText passwordEditText = (EditText)findViewById(R.id.password_edit_text);
        CheckBox rememberUser = (CheckBox) findViewById(R.id.remember_me_checkbox);

        if (savedInstanceState != null) {
            Log.d(Constants.TAG, "onCreate() method was invoked with a previous state");
//            rememberUser.setChecked(savedInstanceState.getBoolean("checkbox"));
...
//        super.onSaveInstanceState(savedInstanceState);
        ...
        if (rememberUser.isChecked()) {
            savedInstanceState.putString("user", usernameEditText.getText().toString());
            savedInstanceState.putString("password", passwordEditText.getText().toString());
            savedInstanceState.putBoolean("checkbox", true);
        }
